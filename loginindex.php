...
$result = mysqli_query($conn,"SELECT * FROM students WHERE student_id='" . $_POST["username"] . "' and password = '". $_POST["password"]."'");
...
$_SESSION["aid"] = $row['assignment_id'];
                    ...
                    <div id="login-box" align="center">
                        ...
                        <form id="login-form" class="form" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="submit" name="submit" class="btn btn-deficult btn-block" value="Log In">
