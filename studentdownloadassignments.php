...
<h2 align="center">Module Assignments</h2>
<table class="table table-bordered" align="center"  style="margin-top: -50px; color: black; font-size: 14px; border:10px ">
  ...
  <tbody>
    ...
    <tr>
       <th scope="row"><?php echo $module_1 ; ?></th>
			...
			<td><p><a class="b" href="moduleassignmentsforStudents/<?php echo $moduleassignment_1 ; ?>">Download  </a></p></td>
		</td>
      
    </tr>
	      <tr>
      <th scope="row"><?php echo $module_2 ; ?></th>
 			<td><p><a class="b" href="moduleassignmentsforStudents/<?php echo $moduleassignment_2 ; ?>">Download </a></p></td>
      <br>
       ...
       <th scope="row"><?php echo $module_3 ; ?></th>
     			<td><p><a class="b" href="moduleassignmentsforStudents/<?php echo $moduleassignment_3 ; ?>">Download  </a></p></td>
      <br>
    ...
    <td><p><a class="b" href="moduleassignmentsforStudents/<?php echo $moduleassignment_4 ; ?>">Download </a></p></td>
      <br>
    </tr>
	      <tr>
      <th scope="row"><?php echo $module_5 ; ?></th>
      <td><p><a class="b" href="moduleassignmentsforStudents/<?php echo $moduleassignment_5 ; ?>">Download  </a></p></td>
	
    </tr>
	  
	   <tr>
       <th scope="row"><?php echo $module_6; ?></th>
      <td><p><a class="b" href="moduleassignmentsforStudents/<?php echo $moduleassignment_6 ; ?>">Download  </a></p></td>
	
    </tr>
	  
	  <tr>
      <th scope="row"><?php echo $module_7 ; ?></th>
      <td><p><a class="b" href="moduleassignmentsforStudents/<?php echo $moduleassignment_7 ; ?>">Download </a></p></td>
    </tr>
	      <tr>
      <th scope="row"><?php echo $module_8  ; ?></th>
     <td><p><a class="b" href="moduleassignmentsforStudents/<?php echo $moduleassignment_8 ; ?>">Download  </a></p></td>
    </tr>
	  
	   <tr>
      <th scope="row"><?php echo $module_9 ; ?></th>
      <td><p><a class="b" href="moduleassignmentsforStudents/<?php echo $moduleassignment_9 ; ?>">Download </a></p></td>
	
    </tr>
	  
	  <tr>
      <th scope="row"><?php echo $module_10 ; ?></th>
      <td><p><a class="b" href="moduleassignmentsforStudents/<?php echo $moduleassignment_10 ; ?>">Download </a></p></td>
