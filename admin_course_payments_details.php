     ...
     <div align="left" style="font-size:20px; padding: 10px; color: aliceblue">
         Welcome    
		  ...
		  <div class="section2_admin" style="overflow-x: scroll" align="center">
			  			  ...
			  			  <h1 align="center">Course Payments  </h1><hr>
			  
			  
	<div align="center"   style="margin-top: 5px" >
     <button type="button"   data-toggle="modal" data-target="#model" class="btn btn-primary btn-md"><i class="fa fa-plus"></i>&nbsp;Add A New Course Payment</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel1">Add A New Course Payment </h5>
		 
     <button type="button" class="close" data-dismiss="modal">close</i></button>
 
    </div>
	  <form method="post" action="admin_course_payments_manage.php"  enctype="multipart/form-data"> 
    ...
    <br>
     ...
     <input type="text" name="payment_1"  class="form-control" placeholder="payment 1" required/>
   <br> 
	
     <input type="text" name="payment_2" class="form-control" placeholder="payment 2" required/>
   
	<br> 
     <input type="text" name="payment_3" class="form-control" placeholder="payment 3" required/>
		
	 <br> 
	
     <input type="text" name="payment_4" class="form-control" placeholder="payment 4" required/>
   
	<br> 
     <input type="text" name="payment_5" class="form-control" placeholder="payment 5" required/>	
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Update an Exiting Course Payment </h5>
		<form method="post" action="admin_course_payment_update.php"  enctype="multipart/form-data"> 	
...
<br>
   ...
   <br>
     ...
     <input type="text" name="payment_1" id="payment_1" class="form-control" placeholder="Payment 1"  required/>
  <br>
<label>Payment 2</label>
     <input type="text" name="payment_2" id="payment_2"  class="form-control" placeholder="Payment 2" required/>
   <br> 
	<label>Payment 3</label>
     <input type="text" name="payment_3" id="payment_3" class="form-control" placeholder="Payment 3" required/>
   
	<br> 
		  <label>Payment 4</label>
     <input type="text" name="payment_4" id="payment_4" class="form-control" placeholder="Payment 4" required/>
     
    <br> 
		  <label>Payment 5</label>
     <input type="text" name="payment_5" id="payment_5" class="form-control" placeholder="Payment 5" required/>
  ...
  <thead>
	...
	<th  class="hidden" scope="col">Payment 1</th>
    <th  class="hidden" scope="col"> Payment 2</th>
	<th  class="hidden" scope="col"> Payment 3</th>
    <th  class="hidden" scope="col">Payment 4</th>
	<th  class="hidden" scope="col">Payment 5</th>
  ...
  <tbody>
    ...
    <tr>
	  ...
	  <td><?php echo $row['course_name']; ?></td>
	   <td  class="hidden"><?php echo $row['payment_1']; ?></td>
		 <td  class="hidden"><?php echo $row['payment_2']; ?></td>
		 <td  class="hidden"><?php echo $row['payment_3']; ?></td>
		 <td   class="hidden"><?php echo $row['payment_4']; ?></td>
		 <td  class="hidden" ><?php echo $row['payment_5']; ?></td>
		 
		 <td><button type="button" class="btn btn-success btn-xs editbtn"><i class="fa fa-list fa-cog" aria-hidden="true"></i></button></td>
 		 <td><a href="admin_course_payments_manage.php?delete= <?php echo $row['course_id']; ?> " class="btn btn-danger btn-xs"><i class="fa fa-trash"></a></td>
    </tr>
  </tbody>
...
<script>
		$(document).ready(function() {
			...
			console.log(data);
				...
				$('#payment_1').val(data[2]);
				$('#payment_2').val(data[3]);
				$('#payment_3').val(data[4]);
				$('#payment_4').val(data[5]);
				$('#payment_5').val(data[6]);
