...
<h2 align="center">Student Payments</h2>
<table class="table table-bordered" align="center"  style="  color: black; font-size: 14px; border:10px ">
  <thead>
    <tr>
  ...
  <tbody>
	...
	<td><?php echo $payment2_status ; ?></td>
	  ...
	  <td><?php echo $payment4_status ; ?></td>
	    ...
	    <tr>
      <th scope="row">Payment 5</th>
      <td ><?php echo $payment_5 ; ?></td>
	  <td><?php echo $payment5_status ; ?></td>
	   ...
	   <tr>
      <th scope="row">Final Payment Status</th>
      <td ></td>
